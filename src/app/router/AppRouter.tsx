...
const VideoLearningPlayerPage = lazy(() =>
  import('../../modules/training/pages/VideoLearningPlayerPage').then((module) => ({
  ...
  <BrowserRouter>
    <ProjectProvider>
      <Routes>
        ...
        <Route path="/tv/*" element={withPageGuard(<PublicTrainingVideoPage />, '员工培训视频')} />
