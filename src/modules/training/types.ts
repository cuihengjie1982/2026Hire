import type {VideoPolarity, VideoSeverity, VideoTaxonomyOption} from './videoTaxonomy';

export type {VideoPolarity, VideoSeverity, VideoTaxonomy, VideoTaxonomyOption} from './videoTaxonomy';
